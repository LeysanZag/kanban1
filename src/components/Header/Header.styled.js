...
// `;
// export const HeaderLogoImgDark = styled(HeaderLogoImg)`
// src="images/logo_dark.png" alt="logo"
// `;
...
export const HeaderPopUserSetMail = styled.p`
  color: #94a6be;
  font-size: 14px;
  line-height: 21px;
  letter-spacing: -0.14px;
...
export const HeaderPopUserSetThemeText = styled.div`
  color: #000;
  font-size: 14px;
  line-height: 21px;
  letter-spacing: -0.14px;
